		...
		public Introduction3 ()
		      {
				...
				gc.fillText ("Introduction p 3", width * 0.6, height * 0.099);
				...
				gc.setFill (Color.BLACK);
				gc.setFont (textFont);
				gc.fillText ("Sudhir Kaicker", width * 0.09, height * 0.513);
				gc.fillText ("Mentor Professor, Computer Science & Engineering", width * 0.09, height * 0.567);
				gc.fillText ("NIIT University, Neemrana, Rajasthan, India", width * 0.09, height * 0.621);
				gc.fillText ("Contact: sudhir_kaicker@hotmail.com", width * 0.09, height * 0.675);
